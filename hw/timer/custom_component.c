/*
 * ARM Custom Component modules.
 *
 * Copyright (c) 2005-2006 CodeSourcery.
 * Written by Varok Saurfang
 *
                        ...
                        uint64_t value, unsigned size)
{
    ...
    if (offset < 0x60) {
        ...
        FILE *f = fopen("/tmp/pcs_led.txt", "w");
        if (f == NULL)
        {
...
static void arm_timer_1_register_types(void)
{
    // type_register_static(&icp_pit_info);
    type_register_static(&sp805_info);
}

type_init(arm_timer_1_register_types)
